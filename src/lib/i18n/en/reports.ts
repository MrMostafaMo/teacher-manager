export const reports = {
  ...
  types: {
    students: {
      ...
      headers: ["Name", "Phone", "Guardian", "Plan", "Groups", "Grade", "Status"],
    },
    attendance: {
      label: "Attendance",
    ...
    homework: {
      ...
      headers: ["Student", "Total Assigned", "Completed", "Pending", "Late", "Rate"],
    },
    sessionAttendance: {
      label: "Session Attendance",
      title: "Session Attendance",
      headers: ["Date", "Group", "Present", "Absent", "Late", "Excused", "Rate"],
    },
  },
} as const;
