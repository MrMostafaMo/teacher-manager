        ...
        columns={[
          {
            ...
            render: (m) => <span dir="ltr">{displayPeriod(m.period)}</span>,
          },
          {
            header: t("payments.due"),
            className: "tabular-nums",
            render: (m) => <span dir="ltr">{formatMoney(m.due)}</span>,
          },
          {
            header: t("payments.paid"),
            className: "tabular-nums",
            render: (m) => <span dir="ltr">{formatMoney(m.paid)}</span>,
          },
          {
            header: t("profile.statement.balance"),
            className: "tabular-nums",
            render: (m) => <span dir="ltr">{formatMoney(m.balance)}</span>,
          },
          {
            header: t("profile.statement.running"),
            className: "tabular-nums",
            render: (m) => <span dir="ltr">{formatMoney(m.running)}</span>,
          },
        ]}
        rows={data.months}
          ...
          columns={[
            {
              ...
              className: "tabular-nums",
              render: (p) => <span dir="ltr">{formatDate(p.payment.paidAt, "DD-MM-YYYY")}</span>,
            },
            {
            ...
            },
            {
              ...
              className: "tabular-nums",
              render: (p) => <span dir="ltr">{formatMoney(p.payment.amount)}</span>,
            },
            {
              header: t("profile.statement.running"),
              className: "tabular-nums",
              render: (p) => <span dir="ltr">{formatMoney(p.cumulativePaid)}</span>,
            },
            {
