...
function homework(overrides: Partial<HomeworkListItem> = {}): HomeworkListItem {
  return {
    id: "h1", groupId: "g1", title: "Algebra p.40", description: null, dueDate: "2026-08-10",
...
function due(overrides: Partial<DuesRow> = {}): DuesRow {
  return {
    student: { id: "st1", name: "Ahmed", phone: null, guardianName: null, guardianPhone: null, status: "active", notes: null, planId: null, enrolledOn: "2026-07-01", createdAt: 0, updatedAt: 0 },
