...
type CardRow = { student: { id: string; name: string }; count: number; sessionsPerCycle: number; cycleNumber: number; status: "ok" | "warning" | "due"; isPaid: boolean };
            ...
            {filtered.map((r) => (
              <div key={r.student.id} className="flex items-center justify-between gap-3 py-2">
                ...
                <span className="flex items-center gap-2">
                  <span className="text-sm tabular-nums" dir="ltr">{r.count}/{r.sessionsPerCycle}</span>
